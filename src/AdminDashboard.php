...
class AdminDashboard
{
    ...
    public function init_menu()
    {
        ...
        // إضافة صفحة فرعية للإحصائيات
        add_submenu_page(
            'thawani_gw',
            __('إحصائيات المبيعات', 'thawani'),
            __('الإحصائيات', 'thawani'),
            'manage_woocommerce',
            'thawani_statistics',
            [$this, 'statistics_template']
        );
    }
    ...
    public function statistics_template()
    {
        include THAWANI_GW_DIR . 'template/statistics.php';
    }
